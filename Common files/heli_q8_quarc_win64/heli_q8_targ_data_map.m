  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% heli_q8_P.convert_Gain
	  section.data(33).logicalSrcIdx = 103;
	  section.data(33).dtTransOffset = 32;
	
	  ;% heli_q8_P.elev_rad_offset_Value
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% heli_q8_DW.p_Scope_PWORK.LoggedData
	  section.data(8).logicalSrcIdx = 21;
	  section.data(8).dtTransOffset = 7;
	
	  ;% heli_q8_DW.p_Scope1_PWORK.LoggedData
  ...
  targMap.checksum0 = 3559141835;
  targMap.checksum1 = 2928971773;
  targMap.checksum2 = 3113778610;
  targMap.checksum3 = 586645076;
