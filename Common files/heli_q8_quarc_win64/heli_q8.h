...
typedef struct {
  ...
  real_T Joystick_gain_y_o;            /* '<Root>/Joystick_gain_y' */
  ...
  real_T convert2[6];                  /* '<Root>/convert 2' */
...
typedef struct {
  ...
  struct {
    void *LoggedData;
  } p_Scope_PWORK;                     /* '<Root>/p_Scope' */

  struct {
    void *LoggedData;
  } p_Scope1_PWORK;                    /* '<Root>/p_Scope1' */
...
struct P_heli_q8_T_ {
  real_T Joystick_gain_x;              /* Variable: Joystick_gain_x
                                        * Referenced by:
                                        *   '<Root>/Joystick_gain_x'
                                        *   '<S4>/Joystick_gain_x'
                                        */
  real_T Joystick_gain_y;              /* Variable: Joystick_gain_y
                                        * Referenced by:
                                        *   '<Root>/Joystick_gain_y'
                                        *   '<S4>/Joystick_gain_y'
                                        */
  real_T Vd_star;                      /* Variable: Vd_star
                                        * Referenced by: '<Root>/Vd offset'
                                        */
  ...
  real_T Gain_Gain_n;                  /* Expression: 180/pi
                                        ...
                                        */
  real_T convert2_Gain;                /* Expression: pi/180
                                        * Referenced by: '<Root>/convert 2'
                                        */
  ...
  real_T Integrator_LowerSat;          /* Expression: -inf
                                        * Referenced by: '<S6>/Integrator'
                                        */
  real_T convert_Gain;                 /* Expression: pi/180
                                        * Referenced by: '<Root>/convert '
                                        */
  real_T elev_rad_offset_Value;        /* Expression: 29.5*pi/180
                                        * Referenced by: '<Root>/elev_rad_offset'
                                        */
