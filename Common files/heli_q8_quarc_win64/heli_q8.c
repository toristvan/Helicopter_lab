 ...
 * C source code generated on : Fri Oct 19 13:13:33 2018
 *
...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    /* S-Function Block: heli_q8/Heli 3D/HIL Read Encoder Timebase (hil_read_encoder_timebase_block) */
    {
      ...
      if (result < 0) {
        ...
        rtb_FrontmotorSaturation = heli_q8_DW.HILReadEncoderTimebase_Buffer[2];
      }
    }
    ...
    if (heli_q8_B.RateTransitiony > heli_q8_P.DeadZoney_End) {
      rtb_BackmotorSaturation = heli_q8_B.RateTransitiony -
    ...
    /* Gain: '<Root>/Joystick_gain_y' */
    heli_q8_B.Joystick_gain_y_o = heli_q8_P.Joystick_gain_y *
    ...
    if (rtmIsMajorTimeStep(heli_q8_M)) {
      {
        if (!(++heli_q8_DW.ToFile_IWORK.Decimation % 1) &&
          ...
          if (fp != (NULL)) {
            ...
            u[1] = heli_q8_B.Joystick_gain_y_o;
            if (fwrite(u, sizeof(real_T), 2, fp) != 2) {
              rtmSetErrorStatus(heli_q8_M,
                                "Error writing to MAT-file part1_prob4.mat");
              return;
            }
            ...
            if (((++heli_q8_DW.ToFile_IWORK.Count)*2)+1 >= 100000000) {
              (void)fprintf(stdout,
                            ...
                            "    allowed in MAT-file part1_prob4.mat.\n");
            }
          }
        }
      }
  ...
  /* Gain: '<Root>/convert 2' */
  heli_q8_B.convert2[0] = heli_q8_P.convert2_Gain * heli_q8_B.Gain;
  heli_q8_B.convert2[1] = heli_q8_P.convert2_Gain * heli_q8_B.Gain_d;
  heli_q8_B.convert2[2] = heli_q8_P.convert2_Gain * heli_q8_B.Gain_i;
  heli_q8_B.convert2[3] = heli_q8_P.convert2_Gain * heli_q8_B.Gain_b;
  heli_q8_B.convert2[4] = heli_q8_P.convert2_Gain * heli_q8_B.Gain_e;
  heli_q8_B.convert2[5] = heli_q8_P.convert2_Gain * heli_q8_B.Gain_dg;
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    if (rtmIsMajorTimeStep(heli_q8_M)) {
      {
        if (!(++heli_q8_DW.ToFile1_IWORK.Decimation % 1) &&
          ...
          if (fp != (NULL)) {
            ...
            u[0] = heli_q8_M->Timing.t[1];
            u[1] = heli_q8_B.convert2[2];
            if (fwrite(u, sizeof(real_T), 2, fp) != 2) {
              rtmSetErrorStatus(heli_q8_M,
                                "Error writing to MAT-file part1_prob3_pitch.mat");
              return;
            }
            ...
            if (((++heli_q8_DW.ToFile1_IWORK.Count)*2)+1 >= 100000000) {
              (void)fprintf(stdout,
                            ...
                            "    the simulation has ended, because it has reached\n"
                            "    the maximum number of elements (100000000)\n"
                            "    allowed in MAT-file part1_prob3_pitch.mat.\n");
            }
          }
        }
      }
    ...
    if (rtmIsMajorTimeStep(heli_q8_M)) {
      {
        if (!(++heli_q8_DW.ToFile2_IWORK.Decimation % 1) &&
          ...
          if (fp != (NULL)) {
            ...
            u[0] = heli_q8_M->Timing.t[1];
            u[1] = heli_q8_B.convert2[1];
            if (fwrite(u, sizeof(real_T), 2, fp) != 2) {
              rtmSetErrorStatus(heli_q8_M,
                                "Error writing to MAT-file part1_prob3_travel_rate.mat");
              return;
            }
            ...
            if (((++heli_q8_DW.ToFile2_IWORK.Count)*2)+1 >= 100000000) {
              (void)fprintf(stdout,
                            ...
                            "    the simulation has ended, because it has reached\n"
                            "    the maximum number of elements (100000000)\n"
                            "    allowed in MAT-file part1_prob3_travel_rate.mat.\n");
            }
          }
        }
      }
    ...
    if (rtmIsMajorTimeStep(heli_q8_M)) {
      {
        if (!(++heli_q8_DW.ToFile3_IWORK.Decimation % 1) &&
          ...
          if (fp != (NULL)) {
            ...
            u[0] = heli_q8_M->Timing.t[1];
            u[1] = heli_q8_B.convert2[0];
            if (fwrite(u, sizeof(real_T), 2, fp) != 2) {
              rtmSetErrorStatus(heli_q8_M,
                                "Error writing to MAT-file part1_prob3_travel.mat");
              return;
            }
            ...
            if (((++heli_q8_DW.ToFile3_IWORK.Count)*2)+1 >= 100000000) {
              (void)fprintf(stdout,
                            ...
                            "    the simulation has ended, because it has reached\n"
                            "    the maximum number of elements (100000000)\n"
                            "    allowed in MAT-file part1_prob3_travel.mat.\n");
            }
          }
        }
      }
    ...
    if (rtmIsMajorTimeStep(heli_q8_M)) {
      {
        if (!(++heli_q8_DW.ToFile4_IWORK.Decimation % 1) &&
          ...
          if (fp != (NULL)) {
            ...
            u[0] = heli_q8_M->Timing.t[1];
            u[1] = heli_q8_B.convert2[5];
            if (fwrite(u, sizeof(real_T), 2, fp) != 2) {
              rtmSetErrorStatus(heli_q8_M,
                                "Error writing to MAT-file part1_prob3_elevation_rate.mat");
              return;
            }
            ...
            if (((++heli_q8_DW.ToFile4_IWORK.Count)*2)+1 >= 100000000) {
              (void)fprintf(stdout,
                            ...
                            "    the simulation has ended, because it has reached\n"
                            "    the maximum number of elements (100000000)\n"
                            "    allowed in MAT-file part1_prob3_elevation_rate.mat.\n");
            }
          }
        }
      }
    ...
    if (rtmIsMajorTimeStep(heli_q8_M)) {
      {
        if (!(++heli_q8_DW.ToFile5_IWORK.Decimation % 1) &&
          ...
          if (fp != (NULL)) {
            ...
            u[0] = heli_q8_M->Timing.t[1];
            u[1] = heli_q8_B.convert2[4];
            if (fwrite(u, sizeof(real_T), 2, fp) != 2) {
              rtmSetErrorStatus(heli_q8_M,
                                "Error writing to MAT-file part1_prob3_elevation.mat");
              return;
            }
            ...
            if (((++heli_q8_DW.ToFile5_IWORK.Count)*2)+1 >= 100000000) {
              (void)fprintf(stdout,
                            ...
                            "    the simulation has ended, because it has reached\n"
                            "    the maximum number of elements (100000000)\n"
                            "    allowed in MAT-file part1_prob3_elevation.mat.\n");
            }
          }
        }
      }
    ...
    if (rtmIsMajorTimeStep(heli_q8_M)) {
      {
        if (!(++heli_q8_DW.ToFile6_IWORK.Decimation % 1) &&
          ...
          if (fp != (NULL)) {
            ...
            u[0] = heli_q8_M->Timing.t[1];
            u[1] = heli_q8_B.convert2[3];
            if (fwrite(u, sizeof(real_T), 2, fp) != 2) {
              rtmSetErrorStatus(heli_q8_M,
                                "Error writing to MAT-file part1_prob3_pitch_rate.mat");
              return;
            }
            ...
            if (((++heli_q8_DW.ToFile6_IWORK.Count)*2)+1 >= 100000000) {
              (void)fprintf(stdout,
                            ...
                            "    the simulation has ended, because it has reached\n"
                            "    the maximum number of elements (100000000)\n"
                            "    allowed in MAT-file part1_prob3_pitch_rate.mat.\n");
            }
          }
        }
      }
     ...
     *  Constant: '<Root>/Vd offset'
     *  Gain: '<Root>/Joystick_gain_x'
     */
    rtb_BackmotorSaturation = heli_q8_P.Joystick_gain_x *
      heli_q8_B.Joystick_gain_x + heli_q8_P.Vd_star;

    /* Sum: '<Root>/Sum1' */
    rtb_FrontmotorSaturation = heli_q8_B.Joystick_gain_y_o + 0.0;

    /* Sum: '<S1>/Add' */
    rtb_ElevationTransferFcn = rtb_BackmotorSaturation +
      rtb_FrontmotorSaturation;

    /* Gain: '<S1>/Back gain' incorporates:
     *  Sum: '<S1>/Subtract'
     */
    rtb_BackmotorSaturation = (rtb_FrontmotorSaturation -
      rtb_BackmotorSaturation) * heli_q8_P.Backgain_Gain;

    /* Gain: '<S1>/Front gain' */
    rtb_FrontmotorSaturation = heli_q8_P.Frontgain_Gain *
      rtb_ElevationTransferFcn;
  }
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
     ...
     *  Constant: '<Root>/elev_rad_offset'
     *  Gain: '<Root>/convert '
     *  Sum: '<S2>/Sum'
     */
    heli_q8_B.K_ei = (heli_q8_P.elev_rad_offset_Value - heli_q8_P.convert_Gain *
                      heli_q8_B.Gain_e) * heli_q8_P.K_ei_Gain;
...
void heli_q8_initialize(void)
{
  ...
  {
    char fileName[509] = "part1_prob4.mat";
    FILE *fp = (NULL);
    if ((fp = fopen(fileName, "wb")) == (NULL)) {
      rtmSetErrorStatus(heli_q8_M, "Error creating .mat file part1_prob4.mat");
      return;
    }

    if (rt_WriteMat4FileHeader(fp,2,0,"V_s_equil")) {
      rtmSetErrorStatus(heli_q8_M,
                        "Error writing mat file header to file part1_prob4.mat");
      return;
    }
  ...
  {
    char fileName[509] = "part1_prob3_pitch.mat";
    FILE *fp = (NULL);
    if ((fp = fopen(fileName, "wb")) == (NULL)) {
      rtmSetErrorStatus(heli_q8_M,
                        "Error creating .mat file part1_prob3_pitch.mat");
      return;
    }

    if (rt_WriteMat4FileHeader(fp,2,0,"pitch")) {
      rtmSetErrorStatus(heli_q8_M,
                        "Error writing mat file header to file part1_prob3_pitch.mat");
      return;
    }
  ...
  {
    char fileName[509] = "part1_prob3_travel_rate.mat";
    FILE *fp = (NULL);
    if ((fp = fopen(fileName, "wb")) == (NULL)) {
      rtmSetErrorStatus(heli_q8_M,
                        "Error creating .mat file part1_prob3_travel_rate.mat");
      return;
    }

    if (rt_WriteMat4FileHeader(fp,2,0,"travel_rate")) {
      rtmSetErrorStatus(heli_q8_M,
                        "Error writing mat file header to file part1_prob3_travel_rate.mat");
      return;
    }
  ...
  {
    char fileName[509] = "part1_prob3_travel.mat";
    FILE *fp = (NULL);
    if ((fp = fopen(fileName, "wb")) == (NULL)) {
      rtmSetErrorStatus(heli_q8_M,
                        "Error creating .mat file part1_prob3_travel.mat");
      return;
    }

    if (rt_WriteMat4FileHeader(fp,2,0,"travel")) {
      rtmSetErrorStatus(heli_q8_M,
                        "Error writing mat file header to file part1_prob3_travel.mat");
      return;
    }
  ...
  {
    char fileName[509] = "part1_prob3_elevation_rate.mat";
    FILE *fp = (NULL);
    if ((fp = fopen(fileName, "wb")) == (NULL)) {
      rtmSetErrorStatus(heli_q8_M,
                        "Error creating .mat file part1_prob3_elevation_rate.mat");
      return;
    }

    if (rt_WriteMat4FileHeader(fp,2,0,"elevation_rate")) {
      rtmSetErrorStatus(heli_q8_M,
                        "Error writing mat file header to file part1_prob3_elevation_rate.mat");
      return;
    }
  ...
  {
    char fileName[509] = "part1_prob3_elevation.mat";
    FILE *fp = (NULL);
    if ((fp = fopen(fileName, "wb")) == (NULL)) {
      rtmSetErrorStatus(heli_q8_M,
                        "Error creating .mat file part1_prob3_elevation.mat");
      return;
    }

    if (rt_WriteMat4FileHeader(fp,2,0,"elevation")) {
      rtmSetErrorStatus(heli_q8_M,
                        "Error writing mat file header to file part1_prob3_elevation.mat");
      return;
    }
  ...
  {
    char fileName[509] = "part1_prob3_pitch_rate.mat";
    FILE *fp = (NULL);
    if ((fp = fopen(fileName, "wb")) == (NULL)) {
      rtmSetErrorStatus(heli_q8_M,
                        "Error creating .mat file part1_prob3_pitch_rate.mat");
      return;
    }

    if (rt_WriteMat4FileHeader(fp,2,0,"pitch_rate")) {
      rtmSetErrorStatus(heli_q8_M,
                        "Error writing mat file header to file part1_prob3_pitch_rate.mat");
      return;
    }
...
void heli_q8_terminate(void)
{
  ...
  /* Terminate for ToFile: '<Root>/To File' */
  {
    ...
    if (fp != (NULL)) {
      char fileName[509] = "part1_prob4.mat";
      if (fclose(fp) == EOF) {
        rtmSetErrorStatus(heli_q8_M, "Error closing MAT-file part1_prob4.mat");
        return;
      }

      if ((fp = fopen(fileName, "r+b")) == (NULL)) {
        rtmSetErrorStatus(heli_q8_M, "Error reopening MAT-file part1_prob4.mat");
        return;
      }

      if (rt_WriteMat4FileHeader(fp, 2, heli_q8_DW.ToFile_IWORK.Count,
           "V_s_equil")) {
        rtmSetErrorStatus(heli_q8_M,
                          "Error writing header for V_s_equil to MAT-file part1_prob4.mat");
      }
  ...
  /* Terminate for ToFile: '<Root>/To File1' */
  {
    ...
    if (fp != (NULL)) {
      ...
      if (fclose(fp) == EOF) {
        rtmSetErrorStatus(heli_q8_M,
                          "Error closing MAT-file part1_prob3_pitch.mat");
        return;
      }

      if ((fp = fopen(fileName, "r+b")) == (NULL)) {
        rtmSetErrorStatus(heli_q8_M,
                          "Error reopening MAT-file part1_prob3_pitch.mat");
        return;
      }

      if (rt_WriteMat4FileHeader(fp, 2, heli_q8_DW.ToFile1_IWORK.Count, "pitch"))
      {
        rtmSetErrorStatus(heli_q8_M,
                          "Error writing header for pitch to MAT-file part1_prob3_pitch.mat");
      }
  ...
  /* Terminate for ToFile: '<Root>/To File2' */
  {
    ...
    if (fp != (NULL)) {
      ...
      if (fclose(fp) == EOF) {
        rtmSetErrorStatus(heli_q8_M,
                          "Error closing MAT-file part1_prob3_travel_rate.mat");
        return;
      }

      if ((fp = fopen(fileName, "r+b")) == (NULL)) {
        rtmSetErrorStatus(heli_q8_M,
                          "Error reopening MAT-file part1_prob3_travel_rate.mat");
        return;
      }

      if (rt_WriteMat4FileHeader(fp, 2, heli_q8_DW.ToFile2_IWORK.Count,
           "travel_rate")) {
        rtmSetErrorStatus(heli_q8_M,
                          "Error writing header for travel_rate to MAT-file part1_prob3_travel_rate.mat");
      }
  ...
  /* Terminate for ToFile: '<Root>/To File3' */
  {
    ...
    if (fp != (NULL)) {
      ...
      if (fclose(fp) == EOF) {
        rtmSetErrorStatus(heli_q8_M,
                          "Error closing MAT-file part1_prob3_travel.mat");
        return;
      }

      if ((fp = fopen(fileName, "r+b")) == (NULL)) {
        rtmSetErrorStatus(heli_q8_M,
                          "Error reopening MAT-file part1_prob3_travel.mat");
        return;
      }

      if (rt_WriteMat4FileHeader(fp, 2, heli_q8_DW.ToFile3_IWORK.Count, "travel"))
      {
        rtmSetErrorStatus(heli_q8_M,
                          "Error writing header for travel to MAT-file part1_prob3_travel.mat");
      }
  ...
  /* Terminate for ToFile: '<Root>/To File4' */
  {
    ...
    if (fp != (NULL)) {
      ...
      if (fclose(fp) == EOF) {
        rtmSetErrorStatus(heli_q8_M,
                          "Error closing MAT-file part1_prob3_elevation_rate.mat");
        return;
      }

      if ((fp = fopen(fileName, "r+b")) == (NULL)) {
        rtmSetErrorStatus(heli_q8_M,
                          "Error reopening MAT-file part1_prob3_elevation_rate.mat");
        return;
      }

      if (rt_WriteMat4FileHeader(fp, 2, heli_q8_DW.ToFile4_IWORK.Count,
           "elevation_rate")) {
        rtmSetErrorStatus(heli_q8_M,
                          "Error writing header for elevation_rate to MAT-file part1_prob3_elevation_rate.mat");
      }
  ...
  /* Terminate for ToFile: '<Root>/To File5' */
  {
    ...
    if (fp != (NULL)) {
      ...
      if (fclose(fp) == EOF) {
        rtmSetErrorStatus(heli_q8_M,
                          "Error closing MAT-file part1_prob3_elevation.mat");
        return;
      }

      if ((fp = fopen(fileName, "r+b")) == (NULL)) {
        rtmSetErrorStatus(heli_q8_M,
                          "Error reopening MAT-file part1_prob3_elevation.mat");
        return;
      }

      if (rt_WriteMat4FileHeader(fp, 2, heli_q8_DW.ToFile5_IWORK.Count,
           "elevation")) {
        rtmSetErrorStatus(heli_q8_M,
                          "Error writing header for elevation to MAT-file part1_prob3_elevation.mat");
      }
  ...
  /* Terminate for ToFile: '<Root>/To File6' */
  {
    ...
    if (fp != (NULL)) {
      ...
      if (fclose(fp) == EOF) {
        rtmSetErrorStatus(heli_q8_M,
                          "Error closing MAT-file part1_prob3_pitch_rate.mat");
        return;
      }

      if ((fp = fopen(fileName, "r+b")) == (NULL)) {
        rtmSetErrorStatus(heli_q8_M,
                          "Error reopening MAT-file part1_prob3_pitch_rate.mat");
        return;
      }

      if (rt_WriteMat4FileHeader(fp, 2, heli_q8_DW.ToFile6_IWORK.Count,
           "pitch_rate")) {
        rtmSetErrorStatus(heli_q8_M,
                          "Error writing header for pitch_rate to MAT-file part1_prob3_pitch_rate.mat");
      }
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (3559141835U);
  heli_q8_M->Sizes.checksums[1] = (2928971773U);
  heli_q8_M->Sizes.checksums[2] = (3113778610U);
  heli_q8_M->Sizes.checksums[3] = (586645076U);
  ...
  heli_q8_M->Sizes.numBlockPrms = (149);/* Sum of parameter "widths" */
  return heli_q8_M;
}
